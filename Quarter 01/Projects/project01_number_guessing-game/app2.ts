...
async function askForGuess() {
  ...
  if (guessedNumber === randomNumber) {
    ...
    console.log(
      chalk.bgRed.white(
        `Too Low, kindly guess again. Your remaining chances are ${remainingChances}.`
      )
    );
    ...
    if (remainingChances === 0) {
      console.log(
        chalk.green.bgRed(
          `We are really sorry you had missed all your chances. Correct number is ${randomNumber}`
        )
      );
    } else {
