...
while (loop) {
  ...
  if (input === "Pakistani Rupee") {
    if (output === "US Dollar") {
      console.log(
        `The ${amount} Pakistan Rupee is equal to ${amount / 281} US Dollar`
      );
    } else if (output === "Saudi Riyal") {
      console.log(
        `The ${amount} Pakistan Rupee is equal to ${amount / 75} Saudi Riyal`
      );
    }
  } else if (input === "US Dollar") {
    if (output === "Pakistani Rupee") {
      console.log(
        `The ${amount} US Dollar is equal to ${amount * 281} Pakistan Rupee`
      );
    } else if (output === "Saudi Riyal") {
      console.log(
    ...
    if (output === "Pakistani Rupee") {
      console.log(
        `The ${amount} Saudi Riyal is equal to ${amount * 75} Pakistan Rupee`
      );
