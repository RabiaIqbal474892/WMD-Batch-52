...
let personName: string = "\t   Rabia Iqbal \n";
...
// Stripping whitespaces using trim()
const strippedName2: string = personNameWithWhitespace.trim();

console.log(`Stripped Name2: " ${strippedName2}"`);

// Method 3:

const personNameWithWhitespace3: string = "\t   \n Rabia Iqbal \t \n";

console.log(`Name with whitespace3: ${personNameWithWhitespace3}`);

// Stripping whitespaces using trim()
const strippedName3: string = personNameWithWhitespace.trim();
